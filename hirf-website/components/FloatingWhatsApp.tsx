...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-ink)] text-[var(--color-canvas)] shadow-[var(--shadow-lift)] transition-transform hover:scale-110"
    >
